                  ...
                  <div className="flex-1">
                    <ul className="flex flex-col justify-between h-full">
                      ...
                      <li>
                        ...
                        <p>
                          안녕하세요. 프론트엔드 개발자 김태형입니다. 약 9개월간
                          선배 개발자로부터 멘토링을 받으며 공부하고있으며,
                          꾸준함의 가치를 알고 하루하루 성장하고, 취준생 그룹과
                          함께 스터디를 진행하고 있습니다. 어떤 조직의
                          분위기에도 빠르게 적응하고 업무에 적극적으로 참여할 수
                          있는 능력을 갖췄습니다. 예의를 알고있어 상대를
                          배려하는 화법을 잘 구사하며, 민감한 상황을 빠르게
                          파악하고 센스있게 대응하는 능력이 있습니다.
                        </p>
                      </li>
                      <li>
